...
const char* ei_classifier_inferencing_categories[] = { "nao", "ruido", "sim" };

ei_dsp_named_axis_t ei_dsp_config_11_named_axes[] = {
    { .name = "Signal", .axis = 0 }
};
size_t ei_dsp_config_11_named_axes_size = 1;
EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_11_axes[] = { 0 };
const uint32_t ei_dsp_config_11_axes_size = 1;
ei_dsp_config_mfe_t ei_dsp_config_11 = {
    11, // uint32_t blockId
    4, // int implementationVersion
    1, // int length of axes
    ei_dsp_config_11_named_axes, // named axes
    ei_dsp_config_11_named_axes_size, // size of the named axes array
...
const ei_impulse_t impulse_734469_0 = {
    .project_id = 734469,
    .project_owner = "Gustavo",
    .project_name = "audio",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 7,

    .nn_input_frame_size = 4214,
...
ei_impulse_handle_t impulse_handle_734469_0 = ei_impulse_handle_t( &impulse_734469_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_734469_0;
